	...
	<body>
		<div id="global">
			...
			<table class="center"><tr><td>
				<h2>
					Contrat d'étude de <?php echo utf8_encode($etudiant["prenom"]." ".$etudiant["nom"]);?>
					<?php echo "<a class=\"bouton\" href=\"vue_bulletin.php?nPeriode=$semestre_courant&id_etudiant=$id\">Voir bulletin</a>";?>
					<?php echo "<a class=\"bouton\" href=\"vue_cursus.php?nPeriode=$semestre_courant&id=$id\">Voir cursus</a>";?>
				</h2>
			</td></tr></table>
